...
window.I18N = {
  ru: {
    ...
    faculties_desc: "Три факультета, объединённые единым стандартом академической подготовки и сильной редакционной школой. Восемь кафедр, одна лаборатория data-журналистики и более двадцати программ бакалавриата и магистратуры.",
    news_desc: "Международные соглашения, научные публикации, победы студентов и обновления кампуса — всё, чем живёт OʻzJOKU.",
  ...
  uz: {
    ...
    faculties_desc: "Uch fakultet yagona akademik standart va kuchli tahririyat maktabi bilan birlashgan. Sakkizta kafedra, bitta data-jurnalistika laboratoriyasi va yigirmadan ortiq bakalavriat hamda magistratura dasturlari.",
    news_desc: "Xalqaro shartnomalar, ilmiy nashrlar, talabalar gʻalabalari va kampus yangiliklari — OʻzJOKU hayotining barcha qirralari.",
    cont_kicker: "◆ Aloqa",
  ...
  en: {
    ...
    faculties_desc: "Three faculties sharing one academic standard and a strong newsroom school. Eight departments, one data-journalism lab and more than twenty bachelor’s and master’s programs.",
    news_desc: "International agreements, research publications, student wins and campus updates — everything that keeps OʻzJOKU moving.",
